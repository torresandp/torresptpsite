...
export default function TaxFormsPage() {
  ...
  const taxForms = [
    ...
    { name: 'Schedule 1', title: 'Additional Income and Adjustments to Income', category: 'individual', url: 'https://www.irs.gov/pub/irs-pdf/f1040s1.pdf' },
    { name: 'Schedule 2', title: 'Additional Taxes', category: 'individual', url: 'https://www.irs.gov/pub/irs-pdf/f1040s2.pdf' },
    { name: 'Schedule 3', title: 'Additional Credits and Payments', category: 'individual', url: 'https://www.irs.gov/pub/irs-pdf/f1040s3.pdf' },
    { name: 'Schedule A', title: 'Itemized Deductions', category: 'individual', popular: true, url: 'https://www.irs.gov/pub/irs-pdf/f1040sa.pdf' },
    { name: 'Schedule B', title: 'Interest and Ordinary Dividends', category: 'individual', url: 'https://www.irs.gov/pub/irs-pdf/f1040sb.pdf' },
    { name: 'Schedule C', title: 'Profit or Loss from Business (Sole Proprietorship)', category: 'business', popular: true, url: 'https://www.irs.gov/pub/irs-pdf/f1040sc.pdf' },
    { name: 'Schedule D', title: 'Capital Gains and Losses', category: 'individual', url: 'https://www.irs.gov/pub/irs-pdf/f1040sd.pdf' },
    { name: 'Schedule E', title: 'Supplemental Income and Loss', category: 'individual', url: 'https://www.irs.gov/pub/irs-pdf/f1040se.pdf' },
    ...
    { name: 'Form 8889', title: 'Health Savings Accounts (HSAs)' }
  ];
