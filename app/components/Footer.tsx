                ...
                {services.map((service, index) => (
                  <li key={index}>
                    <button
                      ...
                      className="text-gray-300 hover:text-amber-400 transition-colors cursor-pointer hover:pl-2 duration-300 text-left w-full"
                    >
                      {service}
                    </button>
                  </li>
        ...
        <div className="border-t border-gray-800 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} T&P Professional Services. All rights reserved.
            </p>
